...
class uvc_ssdt_base_seq(uvm_sequence):
    ...
    async def body(self):
        ...
        await super().body()
# ------------------------------------------------------------------------------
# Basic sequence: creates seq. item and starts it
# ------------------------------------------------------------------------------
class uvc_ssdt_basic_seq(uvc_ssdt_base_seq):
    """ Basic sequence for the SSDT-UVC.
        Sequence generating a single item: (data = rand(), valid = rand()).
    """

    def __init__(self, name="ssdt_basic_seq"):
